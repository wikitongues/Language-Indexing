...
class TestAirtableLanguageExtractor(unittest.TestCase):
    ...
    def test_extract_languages(self):
        ...
        self.assertEqual(result[0].wikipedia_url, 'https://en.wikipedia.org/wiki/Ghotuo_language')

        self.assertEqual(result[1].id, 'aab')
        self.assertEqual(result[1].standard_name, 'Alumu-Tesu')
        self.assertEqual(result[1].wikipedia_url, 'https://en.wikipedia.org/wiki/Alumu_language')

        self.assertEqual(result[2].id, 'aac')
        self.assertEqual(result[2].standard_name, 'Ari')
        self.assertEqual(result[2].wikipedia_url, 'https://en.wikipedia.org/wiki/Ari_language_(New_Guinea)')
