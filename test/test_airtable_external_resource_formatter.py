...
class TestAirtableExternalResourceFormatter(unittest.TestCase):
    ...
    def test_get_fields_dict(self):
        ...
        self.assertEqual(EXPECTED_RESOURCE["language_id"], result[field_name.LANGUAGE_FIELD][0])
    ...
    def test_get_fields_without_language(self):
        ...
        self.assertEqual(EXPECTED_RESOURCE_WITHOUT_LANGUAGE["title"], result[field_name.TITLE_FIELD])
        self.assertEqual(EXPECTED_RESOURCE_WITHOUT_LANGUAGE["url"], result[field_name.URL_FIELD])
        self.assertEqual(
            EXPECTED_RESOURCE_WITHOUT_LANGUAGE["link_text"],
            result[field_name.LINK_TEXT_FIELD],
        )
        self.assertEqual(
            EXPECTED_RESOURCE_WITHOUT_LANGUAGE["spider_name"],
            result[field_name.SPIDER_FIELD],
        )
