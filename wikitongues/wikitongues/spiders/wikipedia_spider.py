...
class WikipediaSpiderInput:
    ...
    def __init__(self, iso_codes, exclude_iso_codes, page_size, offset, max_records):
...
class WikipediaSpider(scrapy.Spider):
    ...
    def __init__(self, spider_input, language_data_store, resource_language_service, *args, **kwargs):
